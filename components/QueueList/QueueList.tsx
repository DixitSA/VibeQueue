  ...
  if (error) {
    return (
      <div className="px-6 py-8 text-center" role="alert">
        <p className="text-cream/60 font-display text-sm uppercase tracking-widest">
          Queue unavailable
        </p>
        <p className="text-cream/60 font-sans text-xs mt-2">
          {error.message}
        </p>
      </div>
    );
    ...
    <div className="px-6 pt-8 pb-32 pb-safe">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <p className="text-cream/60 font-sans text-sm text-center max-w-[180px] leading-relaxed">
